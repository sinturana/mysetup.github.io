! function(e, t) {
    ...
    let n = {
        ...
        Nav_Menu: function(t) {
            ...
            if (t.find(".megamenu-ajax-load").length > 0) {
                t.find(".ekit-nav-dropdown-hover").on("mouseenter", ".elementskit-megamenu-has", (function(t) {
                    n(e(this))
                })), t.find(".ekit-nav-dropdown-click").on("click", ".elementskit-megamenu-has", (function(t) {
                    n(e(this))
                }));
                var n = function(n) {
                    let i = n.find(".elementskit-submenu-indicator"),
                        s = n.find(".megamenu-ajax-load"),
                        a = t.find(".ekit-wid-con").data("responsive-breakpoint");
                    s.length && !s.hasClass("ekit-ajax-loading") && e.ajax({
                        ...
                        beforeSend: function() {
                            s.addClass("ekit-ajax-loading"), i.toggleClass("icon icon-down-arrow1 eicon-loading eicon-animation-spin"), e(document).width() <= Number(a) ? i.css({
                                border: "none"
                            }) : i.css({
                                "padding-right": 0,
                                "margin-right": "5px"
                        ...
                        success: function(t) {
                            s.replaceWith(t), i.toggleClass("eicon-loading eicon-animation-spin icon icon-down-arrow1").removeAttr("style"), n.find(".elementor-element").each((function() {
