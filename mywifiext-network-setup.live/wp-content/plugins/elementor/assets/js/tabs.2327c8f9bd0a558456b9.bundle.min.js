            ...
            class baseTabs extends elementorModules.frontend.handlers.Base {
                ...
                handleKeyboardNavigation(e) {
                    const t = e.currentTarget,
                        ...
                        s = a.find(this.getSettings("selectors").tabTitle),
                        i = "vertical" === a.attr("aria-orientation");
                    switch (e.key) {
                        case "ArrowLeft":
                        case "ArrowRight":
                            if (i) return;
                    ...
                    const n = t.getAttribute("data-tab") - 1,
                        ...
                        o = s[n + r];
                    o ? o.focus() : -1 === n + r ? s.last().trigger("focus") : s.first().trigger("focus")
                }
                deactivateActiveTab(e) {
                    const t = this.getSettings(),
                        ...
                        n = this.elements.$tabContents.filter(s);
                    i.add(n).removeClass(a), i.attr({
                        tabindex: "-1",
                        "aria-selected": "false",
                        "aria-expanded": "false"
                ...
                activateTab(e) {
                    ...
                    s.add(i).addClass(a), s.attr({
                        tabindex: "0",
                        "aria-selected": "true",
                        "aria-expanded": "true"
                    }), i[t.showTabFn](n, (() => elementorFrontend.elements.$window.trigger("elementor-pro/motion-fx/recalc"))), i.removeAttr("hidden")
                }
                isActiveTab(e) {
